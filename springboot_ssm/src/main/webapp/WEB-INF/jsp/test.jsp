...
<div style="margin:0 auto;width:1400px;height:900px;background:#f0f0f0;">
  ...
  <!--  
     <table  style="border-collapse:separate;width:800px;/*height:600px;*/ border-spacing:0px 20px;cellspacing:10px;/*background:#000;*/">
      
            <c:if test="${!empty departmentList}">
          
       
                <c:forEach items="${departmentList}" var="department">
                <tr  style="/*width:700px;margin:20px 20px;*/">
              ...
              <tr>
               ...
               <c:if test="${!empty departmentList.sDepartment}">
          
       
                <c:forEach items="${departmentList.sDepartment}" var="sdepartment">
                <tr  style="/*width:700px;margin:20px 20px;*/">
                
                  <td >${sdepartment.sdName}</td>   
