<%@page import="com.domain.Disease"%>
...
<div class=" " style="margin:0 auto;width:1400px;height:100px;">
    ...
    <div style="margin:0 auto;width:1100px;height:200px;/*background:#000;*/">
     ...
     <a style="font-size:20px;vertical-align:middle;width:20px;height:30px;">${disease.sName}</a>
     </div></div>
      <div style="font-size:20px;line-height:30px;">${disease.sDetail}</div>
       </div>


	<div style="width:1600px;margin:0 auto;heigh:500px;/*background:#f0f0f0;*/">
	 <div style="width:350px;margin-left:100px;"><h2>相关医生</h2></div>
	 <c:if test="${!empty disease.doctorList}">
          
       <div style="width:1600px;height:400px;">
                <c:forEach items="${disease.doctorList}" var="doctor">
               ...
               <div style="padding-top:30px; width:150px; height:150px;margin:0 auto;">
                 ...
                 <div class="appoint" style="padding-top:50px;margin:0 atuo;font-size:20px;color:#455c73;height:200px;width:350px;/*background:#000;*/">
                   <p class=" " style="margin-left:20px;width:300px;">
                        <a style="margin-left:30px;" href="<%=basePath%>hospital/getHospital?name=${doctor.dName}">${doctor.dName}</a>
                 ...
                 <!--       <p>电话： ${doctor.dGoodat}</p>  --> 
                   <div style="margin-left:100px;margin-bottom:10px;">   <a href="" style="">现在预约</a> </div>
    ...
    <div class="detail" style="margin:0 auto;margin-top:40px;width:1400px;height:900px;/*background:#000;*/">
    
  <div style="width:300px;margin-left:100px;"><h2>相关医院</h2></div>
	 <table  style="border-collapse:separate; border-spacing:0px 40px;border:1px solid #f0f0f0;">
      
            <c:if test="${!empty disease.hospitalList}">
          
      
                <c:forEach items="${disease.hospitalList}" var="hospital">
               
                <tr  style="width:1300px;margin:20px 20px;border:1px solid #f0f0f0;">
                 
               <td>
                    <image src="${hospital.hPicture}" style="vertical-align:middle;  width:300px; height:300px;margin-left:20px;" />
