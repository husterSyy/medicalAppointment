...
<head>
<meta charset="utf-8">
<title>jQuery简单的用户注册登录表单切换</title>
<%
...
button.--usr-rtn1::before {
  content: '登录';
  action:
}
button.--usr-rtn2::before {
  content: '登录';
  action:
}
...
<div class="wrap flex-c-c">
  <form action="" method="" class="flex-c-c" id="form">
    <ul class="select__list">
      <li id="js-usr-rtn1" class="select__label">手机号登录</li>
      <li id="js-usr-rtn2" class="select__label">密码登录</li>
      <li id="js-usr-new" class="select__label select__label--active">注册</li>
      <li id="js-usr-rst" class="select__label">忘记密码</li>
    </ul>
    <span class="pointer"></span>
  
    <input type="email"  id="email"  placeholder="邮箱" class="ui-field" id="js-field__email"  class="ui-field"/>
    <input type="password"  id="password" name="password"  placeholder="密码" class="ui-field" id="js-field__pass" />
    <input type="password" id="repassword" placeholder="确认密码" class="ui-field" id="js-field__r-pass" />
  			
	<input type="text" name="code" id="code" placeholder="邮箱验证码" class="ui-field" required> 
	<input type="button" name="btn"  class="btn btn-default" id="btn" value="发送验证码"  class="ui-field" />
		  <input type="text" placeholder="用户名" class="ui-field" onblur="checkUserName()"	id="username"	required name="username">			
...
$('#js-usr-rtn1').click(function() {
  $('#js-btn, .pointer, #js-field__pass').removeClass('--usr-rtn2 --usr-new --usr-rst ui-field--hidden');
  $('#js-btn, .pointer').addClass('--usr-rtn1');
  $('#js-field__r-pass').addClass('ui-field--hidden');
  $("#form").attr("action",  "<%=basePath%>user/login.action");
});
$('#js-usr-rtn2').click(function() {
  $('#js-btn, .pointer, #js-field__pass').removeClass('--usr-rtn1 --usr-new --usr-rst ui-field--hidden');
  $('#js-btn, .pointer').addClass('--usr-rtn2');
  $('#js-field__r-pass').addClass('ui-field--hidden');
  $("#form").attr("action",  "<%=basePath%>user/login.action");
});
$('#js-usr-new').click(function() {
  $('#js-btn, .pointer, #js-field__r-pass, #js-field__pass').removeClass('--usr-rtn1 --usr-rtn2 --usr-rst ui-field--hidden');
  $('#js-btn').addClass('--usr-new');
 
   $("#form").attr("action", "<%=basePath%>user/registerServlet");
     $("#form").attr("onsubmit","return checkForm()");
});
$('#js-usr-rst').click(function() {
  $('#js-btn, .pointer').removeClass('--usr-rtn1 --usr-rtn2 --usr-new');
