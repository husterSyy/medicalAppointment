    ...
    <div class="collapse navbar-collapse" id="menu">
        <ul class="nav navbar-nav">
          <li class="active"><a href="<%=basePath%>user/main">首页</a></li>
            <li><a href="#">预约挂号</a></li>
            <li><a href="#">在线咨询</a></li>
             <li><a href="<%=basePath%>artical/allArtical">医护知识</a></li>

                    <li><a href="#">用户交流</a></li>
                    <li><a href="<%=basePath%>user/mine">个人中心</a></li>
...
<div id="search" style="float:right;
 ...
 <form action="<%=basePath%>hospital/selectHospital" method="post">
    ...
    <ul class="u1">
         <li class="l1"><a href="<%=basePath%>artical/ArticalByType?id=6">推荐</a></li>
        <li class="l1"><a href="<%=basePath%>artical/ArticalByType?id=1">医生文章</a></li>
        <li class="l1"><a href="<%=basePath%>artical/ArticalByType?id=2">独家</a></li>
        <li class="l1"><a href="<%=basePath%>artical/ArticalByType?id=3">母婴</a></li>
        <li class="l1"><a href="<%=basePath%>artical/ArticalByType?id=4">生活</a></li>
        <li class="l1"><a href="<%=basePath%>artical/ArticalByType?id=5">问答</a></li>
    </ul>

<div style="background:#f0f0f0;width:1400px;margin:0 auto;height:900px;">


 <div style="font-size:20px;margin-top:30px;margin:30px auto;width:1200px;/*background:#000;*/">
        
        <c:if test="${!empty articalList }">
            <c:forEach items="${articalList }" var="artical">
           <div style="margin-top:30px;/*background:#000;*/">
            <div style="margin-top:30px;width:1200px;height:50px;/*background:#000;*/margin:0 auto;">
           
       <a href="<%=basePath%>artical/readContentById?id=${artical.aId}"> 文章 ${artical.aId }</a>
          
 <a style="margin-left:80px;"> 标题：     ${artical.aTitle }</a>
