...
<html>
    ...
    <form action="<%=request.getContextPath() %>/alipay/createOrder1.action" method="post">
...
<script type="text/javascript">
	...
	function createOrder() {
		$.ajax({
	    	url: hdnContextPath + "/alipay/createOrder1.action",
	    	type: "POST",
	    	data: {"productId": $("#productId").val(), "buyCounts":1 /*$("#buyCounts").val()*/},
	    	dataType: "json",
