...
<body>
<div style="width:600px;height:600px;margin:0 auto;margin-top:100px;">
    <h2 style="margin:0 auto;">微信支付二维码</h2>
	 <div style="width:300px;margin-top:30px;">
	  <input type="hidden" id="qrCodeUrl" style="margin;0 auto;margin-top:100px;"  value="${qrCodeUrl }"/>
	</div>
	<div id="code"></div> 
...
// 		$('#code').qrcode(toUtf8("我还会回来的！"));
		...
		function checkPayResult() {
			$.get(hdnContextPath + "/wxpay/wxPayIsSuccess.action", function(data) {
// 				debugger;
				console.log(data);
				if (data) {
					window.location.href = hdnContextPath +"/wxpay/paySuccess.action";
				}
			});
		}
