...
$(function(){  
    $("#load_geolocation").click(function(ev){  
        ...
        geolocation.getCurrentPosition(function(r){  
          ...
          //    document.getElementById("test1").value = latCurrent;
          //    document.getElementById("test2").value = lngCurrent;
...
//   function submit(){
  //      var frm = document.getElementById("form"); // 获取表单
 //   frm.submit(); // 对表单进行提交
 //   }
...
<div style="margin:0 auto;width:1400px;height:300px;background:#f0f0f0;">
            ...
            <ul class="type1" style="">
                 <li class="list1"><a>医院评分</a> </li>
                <li class="list1"><a href="<%=basePath%>hospital/selectHospitalByRating2">从高到低</a> </li>
                  <li class="list1"><a href="<%=basePath%>hospital/selectHospitalByRating1">从低到高</a> </li>
            </ul>      
          
                    <ul class="type1">
                 <li class="list1" style=""><a>医院等级</a> </li>
                <li class="list1"><a href="<%=basePath%>hospital/selectHospitalByType?type=三级">三级医院</a> </li>
                  <li class="list1"><a href="<%=basePath%>hospital/selectHospitalByType?type=二级">二级医院</a> </li>
            </ul>    
            
                        <ul class="type1">
           
                 <li class="list1"><a>医院位置</a> </li>
                <li class="list1"><a href="<%=basePath%>hospital/selectHospitalByDistance">距离我最近</a> </li>
                
          <!--     <li class="list1">
         <form id="form"  action="<%=basePath%>hospital/selectHospitalByConcreteDistance" method="post">
               <input type="hidden" id="test1" name="test1" value="距离500m" />
                 <input  type="hidden" id="test2"name="test2" value="距离500m"/>
                 <button type="submit" value="提交">提交</button> </form>             
                 </li>       
                 -->
                 
                  <li class="list1"><a href="<%=basePath%>hospital/allHospital">全部</a> </li>
            </ul>    
       
            <ul class="type1">
           
                 <li class="list1"><a>医院类型</a> </li>
                  <li class="list1"><a href="<%=basePath%>hospital/selectHospitalByCategory?category=妇科">妇科医院</a> </li>
                <li class="list1"><a href="<%=basePath%>hospital/selectHospitalByCategory?category=儿童">儿童医院</a> </li>
                   <li class="list1"><a href="<%=basePath%>hospital/selectHospitalByCategory?category=口腔">口腔医院</a> </li>
                <li class="list1"><a href="<%=basePath%>hospital/selectHospitalByCategory?category=肿瘤">肿瘤医院</a> </li>
                  <li class="list1"><a href="<%=basePath%>hospital/selectHospitalByCategory?category=人民">人民医院</a> </li>
                  <li class="list1"><a href="<%=basePath%>hospital/allHospital">全部</a> </li>
            </ul>    
    </div>
    ...
    <div class="detail" style="margin:0 auto;width:1400px;height:900px;/*background:#000;*/">
               ...
               <td>
                 <div class="appoint" style="margin-left:50px;font-size:20px;color:#455c73;margin-right:100px;width:800px;">
                   <p class=" ">
                        ...
                        <a style="margin-left:30px;">类型：${hospital.hType}</a>
                        <a style="margin-left:30px;">评分：${hospital.hRating}</a>
                    </p>
                     <p><a style="mrgin-right:100px;">访问量：   ${hospital.hInquisitionNum}   </a>       <a style="margin-left:30px;">  评论数： ${hospital.hRatingNum}</a></p>
                       
                       <p>电话： ${hospital.hMobile}</p>
                      <p>地址： ${hospital.hAddress}</p>
               <!--    <p>距离： ${hospital.hDistance}</p>  -->
          
                       <a href="<%=basePath%>hospital/getHospital?name=${hospital.hName}" style="float:right">现在预约</a>
...
<div><h2>推荐医院</h2></div>
	 <table  style="border-collapse:separate; border-spacing:0px 40px;">
            ...
            <c:if test="${!empty hospitalList2}">
          
       
                <c:forEach items="${hospitalList2}" var="hospital">
                <tr  style="width:1300px;margin:20px 20px;">
...
<nav aria-label="Page navigation" style="margin-left:300px;">
  ...
  <ul class="pagination">
    <li>
      <a href="<%=basePath%>/hospital/allHospital?pageNo=1" aria-label="Next">第一页 </a>
    </li>
    <li>
      <a href="<%=basePath%>/hospital/allHospital?pageNo=${page.pageNum-1}" aria-label="Previous">
        <span aria-hidden="true">«</span>
      </a>
    </li>
    <c:forEach var="s" begin="1" end="5">
    <li><a href="<%=basePath%>/hospital/allHospital?pageNo=${s}">${s}</a></li>
   </c:forEach>
      <li>
      <a href="<%=basePath%>/hospital/allHospital?pageNo=${page.pageNum+1}" aria-label="Next">
        <span aria-hidden="true">»</span>
      </a>
    </li>
    <li>
      <a href="<%=basePath%>/hospital/allHospital?pageNo=${page.pages}" aria-label="Next">
